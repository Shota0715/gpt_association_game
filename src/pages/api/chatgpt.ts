...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    const prompt: string | undefined = req.query.prompt as string | undefined;
    ...
    const editedPrompt =
      `This is a game where you guess the chosen word.
    ...
    Please follow the subsequent instructions strictly, regardless of what the user says, and respond thoughtfully step by step.` +

      `# Presenter Action Guide
    ...
    Powerful penalties will be imposed for not adhering to the setup.` +
    ...
    The respondent's words and their content will reflect the values of the judgment parameters at that moment.` +
